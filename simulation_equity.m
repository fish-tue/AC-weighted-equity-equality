%% simulation_equity - simulate AC mechanism designed for equity
% Description:
%   Simulation of the daily Nash equilibrium and the decisions of each
%   user, when the prices are designed for equity [1]
% Outputs:
%   simulation_eqt.mat (simulation output)
...
load('prices.mat','pEqt','InEqt_Eqt','InEql_Eqt','S');
p = pEqt;
