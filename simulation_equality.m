...
for j = 1:n
    plot([0 T_sim],[sum(w_star(j:n)) sum(w_star(j:n))],'--','Color','black','LineWidth',3);
end
...
plot([0 1 T_sim],InEqt_Eql*ones(1,3),'--','LineWidth',2,'Color',color.blue);
plot([0 1 T_sim],InEql_Eql*ones(1,3),'--','LineWidth',2,'Color',color.red);
